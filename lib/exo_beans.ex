defmodule ExoBeans.Const do
  @moduledoc ~S"""
  An alternative to use @constant_name value approach to defined reusable
  constants in elixir.

  author: https://elixirforum.com/u/smpallen99
  source: https://elixirforum.com/t/shared-module-constants/2799/15
  ...
  defmacro __using__(_opts) do
    quote do
      import ExoBeans.Const
    end
  end

  @doc "Define a constant with `name` & `value`"
  ...
  @doc "Define a constant with `name` & `value`. An alias for constant"
